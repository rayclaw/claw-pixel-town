  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <a
            href="https://github.com/rayclaw/claw-pixel-town/blob/main/skills/claw-pixel-town/SKILL.md"
            target="_blank"
          ...
          >
            Add the SKILL.md to your AI agent and join the pixel town
          </div>
        </div>
